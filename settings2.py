...
def mainpage():
  ...
  def save_company():
    ...
    invset_prefix = invset_str.get()
    invset_header = invset_win_menu1.get()
    invset_spin1 = invset_spin1.get()
    invset_text1 = invset_str1.get()
    invset_text2 = invset_str2.get()
    invset_text3 = invset_str3.get()
    invset_text4 = invset_str4.get()
    invset_text5 = invset_str5.get()
    invset_text6 = invset_str6.get()
    invset_text7 = invset_str7.get()
    invset_text8 = invset_str8.get()
    invset_text9 = invset_str9.get()
    invset_text10 = invset_str10.get()
    invset_text11 = invset_str11.get()
    invset_text12 = invset_str12.get()
    invset_text13 = invset_str13.get()
    invset_text14 = invset_str14.get()
    invset_text15 = invset_str15.get()
    invset_text16 = invset_str16.get()
    invset_text17 = invset_str17.get()
    invset_text18 = invset_str18.get()
    invset_text19 = invset_str19.get()
    invset_text20 = invset_str20.get()
    invset_text21 = invset_str21.get()
    invset_text22 = invset_str22.get()
    invset_text23 = invset_str23.get()
    invset_predefined = invset_str24.get(1.0,END)
    invset_default = invset_win_menu2.get()
  
  def save_order_settings():
    ordset_prefix = ordset_str.get()
    ordset_header = ordset_win_menu1.get()
    ordset_text1 = ordset_str1.get()
    ordset_text2 = ordset_str2.get()
    ordset_text3 = ordset_str3.get()
    ordset_text4 = ordset_str4.get()
    ordset_text5 = ordset_str5.get()
    ordset_text6 = ordset_str6.get()
    ordset_predefined = ordset_str7.get(1.0,END)
    ordset_default = ordset_win_menu2.get()
    ordset_spin1 = ordset_spin1.get()
    ...
    if not i:
      if filename == "":
        print(12)
        sql = 'insert into company(name, address, email,salestaxno,currency,currencysign,currsignplace,  decimalseperator,excurrency,dateformat,exdate,taxtype,printimageornot,tax1name,tax1rate,printtax1,  tax2name,tax2rate,printtax2,attachment_file_type,miscellanoustab_cbutton1,miscellanoustab_cbutton2,miscellanoustab_cbutton3,miscellanoustab_cbutton4,miscellanoustab_cbutton5,miscellanoustab_cbutton6,Estimate_prefix,Customizeestimatetextlabels,Customizeestimatetextlabels1,Customizeestimatetextlabels2,Customizeestimatetextlabels3,Customizeestimatetextlabels4,Customizeestimatetextlabels5,Defaultestimatetemplate,Startingestimatenumber,Predefinedtextforestimates,adv_Selectedtemplatepreview,est_Headerboxbackgroundcolor,Invoice_prifix,invset_Headerboxbackgroundcolor,Startinginvoicenumber,Customizinvoicetextlabels,Customizinvoicetextlabels1,Customizinvoicetextlabels2,Customizinvoicetextlabels3,Customizinvoicetextlabels4,Customizinvoicetextlabels4,Customizinvoicetextlabels6,Customizinvoicetextlabels7,Customizinvoicetextlabels8,Customizinvoicetextlabels9,Customizinvoicetextlabels10,Customizinvoicetextlabels11,Customizinvoicetextlabels12,Customizinvoicetextlabels13,Customizinvoicetextlabels14,Customizinvoicetextlabels15,Customizinvoicetextlabels16,Customizinvoicetextlabels17,Customizinvoicetextlabels18,Customizinvoicetextlabels19,Customizinvoicetextlabels20,Customizinvoicetextlabels21,Customizinvoicetextlabels22,Predefinedtextforinvoices,Defaultinvoicetemplate,Order_prefix,ordset_Headerboxbackgroundcolor,Customizeordertextlabels,Defaultordertemplate,Customizeordertextlabels1,Customizeordertextlabels2,Customizeordertextlabels3,Customizeordertextlabels4,Customizeordertextlabels5,Startingordernumber,Predefinedtextfororder) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s, %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s, %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
        val = (company_name,company_address,company_mail,company_salestax,currency,currencysign,  currencysign_placement,decimal_sepator,currency_example,date_format,example_dateformat,tax,printimage,  tax1name,tax1rate,printtax1,tax2name,tax2rate,printtax2,radiobut,cbut1,cbut2,cbut3,cbut4,cbut5,cbut6,est_prefix,est_text1,est_text2,est_text3,est_text4,est_text5,est_text6,est_default,est_spin1,est_predefined,adv_default,est_header,invset_prefix,invset_header,invset_spin1,invset_text1,invset_text2,invset_text3,invset_text4,invset_text5,invset_text6,invset_text7,invset_text8,invset_text9,invset_text10,invset_text11,invset_text12,invset_text13,invset_text14,invset_text15,invset_text16,invset_text17,invset_text18,invset_text19,invset_text20,invset_text21,invset_text22,invset_text23,invset_predefined,invset_default)
        fbcursor.execute(sql, val)
        fbilldb.commit()
      else:
        shutil.copyfile(filename, os.getcwd()+'/images/'+filename.split('/')[-1])
        sql = 'insert into company(name, address, email,salestaxno,currency,currencysign,currsignplace,  decimalseperator,excurrency,dateformat,exdate,taxtype,printimageornot,tax1name,tax1rate,printtax1,  tax2name,tax2rate,printtax2,image,attachment_file_type,miscellanoustab_cbutton1,miscellanoustab_cbutton2,miscellanoustab_cbutton3,miscellanoustab_cbutton4,miscellanoustab_cbutton5,miscellanoustab_cbutton6,Estimate_prefix,Customizeestimatetextlabels,Customizeestimatetextlabels1,Customizeestimatetextlabels2,Customizeestimatetextlabels3,Customizeestimatetextlabels4,Customizeestimatetextlabels5,Defaultestimatetemplate,Startingestimatenumber,Predefinedtextforestimates,adv_Selectedtemplatepreview,est_Headerboxbackgroundcolor,Invoice_prifix,invset_Headerboxbackgroundcolor,Startinginvoicenumber,Customizinvoicetextlabels,Customizinvoicetextlabels1,Customizinvoicetextlabels2,Customizinvoicetextlabels3,Customizinvoicetextlabels4,Customizinvoicetextlabels4,Customizinvoicetextlabels6,Customizinvoicetextlabels7,Customizinvoicetextlabels8,Customizinvoicetextlabels9,Customizinvoicetextlabels10,Customizinvoicetextlabels11,Customizinvoicetextlabels12,Customizinvoicetextlabels13,Customizinvoicetextlabels14,Customizinvoicetextlabels15,Customizinvoicetextlabels16,Customizinvoicetextlabels17,Customizinvoicetextlabels18,Customizinvoicetextlabels19,Customizinvoicetextlabels20,Customizinvoicetextlabels21,Customizinvoicetextlabels22,Predefinedtextforinvoices,Defaultinvoicetemplate) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s, %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s, %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,,%s,%s,%s,%s)'
        val = (company_name,company_address,company_mail,company_salestax,currency,currencysign,  currencysign_placement,decimal_sepator,currency_example,date_format,example_dateformat,tax,printimage,  tax1name,tax1rate,printtax1,tax2name,tax2rate,printtax2,filename.split('/')[-1],radiobut,cbut1,cbut2,cbut3,cbut4,cbut5,cbut6,est_prefix,est_text1,est_text2,est_text3,est_text4,est_text5,est_text6,est_default,est_spin1,est_predefined,adv_default,est_header,invset_prefix,invset_header,invset_spin1,invset_text1,invset_text2,invset_text3,invset_text4,invset_text5,invset_text6,invset_text7,invset_text8,invset_text9,invset_text10,invset_text11,invset_text12,invset_text13,invset_text14,invset_text15,invset_text16,invset_text17,invset_text18,invset_text19,invset_text20,invset_text21,invset_text22,invset_text23,invset_predefined,invset_default,ordset_prefix,ordset_header,ordset_text1,ordset_text2,ordset_text3,ordset_text4,ordset_text5,ordset_text6,ordset_default,ordset_spin1,ordset_predefined)
        fbcursor.execute(sql, val)
        fbilldb.commit()
    else:
      if filename == "":
        sql = "update company set name=%s, address=%s, email=%s,salestaxno=%s,currency=%s,currencysign=%s,  currsignplace=%s,decimalseperator=%s,excurrency=%s,dateformat=%s,exdate=%s,taxtype=%s,  printimageornot=%s,tax1name=%s,tax1rate=%s,printtax1=%s,tax2name=%s,tax2rate=%s,printtax2=%s,attachment_file_type=%s,miscellanoustab_cbutton1=%s,miscellanoustab_cbutton2=%s,miscellanoustab_cbutton3=%s,miscellanoustab_cbutton4=%s,miscellanoustab_cbutton5=%s,miscellanoustab_cbutton6=%s,Estimate_prefix=%s,Customizeestimatetextlabels=%s,Customizeestimatetextlabels1=%s,Customizeestimatetextlabels2=%s,Customizeestimatetextlabels3=%s,Customizeestimatetextlabels4=%s,Customizeestimatetextlabels5=%s,Defaultestimatetemplate=%s,Startingestimatenumber=%s,Predefinedtextforestimates=%s,adv_Selectedtemplatepreview=%s,est_Headerboxbackgroundcolor=%s,Invoice_prifix=%s,invset_Headerboxbackgroundcolor=%s,Startinginvoicenumber=%sCustomizinvoicetextlabels=%s,Customizinvoicetextlabels1=%s,Customizinvoicetextlabels2=%s,Customizinvoicetextlabels3=%s,Customizinvoicetextlabels4=%s,Customizinvoicetextlabels4=%s,Customizinvoicetextlabels6=%s,Customizinvoicetextlabels7=%s,Customizinvoicetextlabels8=%s,Customizinvoicetextlabels9=%s,Customizinvoicetextlabels10=%s,Customizinvoicetextlabels11=%s,Customizinvoicetextlabels12=%s,Customizinvoicetextlabels13=%s,Customizinvoicetextlabels14=%s,Customizinvoicetextlabels15=%s,Customizinvoicetextlabels16=%s,Customizinvoicetextlabels17=%s,Customizinvoicetextlabels18=%s,Customizinvoicetextlabels19=%s,Customizinvoicetextlabels20=%s,Customizinvoicetextlabels21=%s,Customizinvoicetextlabels22=%s,,Predefinedtextforinvoices=%s,Defaultinvoicetemplate=%s"
        val = (company_name,company_address,company_mail,company_salestax,currency,currencysign,  currencysign_placement,decimal_sepator,currency_example,date_format,example_dateformat,tax,printimage,  tax1name,tax1rate,printtax1,tax2name,tax2rate,printtax2,radiobut,cbut1,cbut2,cbut3,cbut4,cbut5,cbut6,est_prefix,est_text1,est_text2,est_text3,est_text4,est_text5,est_text6,est_default,est_spin1,est_predefined,adv_default,est_header,invset_prefix,invset_header,invset_spin1,invset_text1,invset_text2,invset_text3,invset_text4,invset_text5,invset_text6,invset_text7,invset_text8,invset_text9,invset_text10,invset_text11,invset_text12,invset_text13,invset_text14,invset_text15,invset_text16,invset_text17,invset_text18,invset_text19,invset_text20,invset_text21,invset_text22,invset_text23,invset_predefined,invset_default,ordset_prefix,ordset_header,ordset_text1,ordset_text2,ordset_text3,ordset_text4,ordset_text5,ordset_text6,ordset_default,ordset_spin1,ordset_predefined)
        fbcursor.execute(sql, val)
        fbilldb.commit()
      else:
        shutil.copyfile(filename, os.getcwd()+'/images/'+filename.split('/')[-1])
        sql = "update company set name=%s, address=%s, email=%s,salestaxno=%s,currency=%s,currencysign=%s,  currsignplace=%s,decimalseperator=%s,excurrency=%s,dateformat=%s,exdate=%s,taxtype=%s,  printimageornot=%s,tax1name=%s,tax1rate=%s,printtax1=%s,tax2name=%s,tax2rate=%s,printtax2=%s,image=%s,attachment_file_type=%s,miscellanoustab_cbutton1=%s,miscellanoustab_cbutton2=%s,miscellanoustab_cbutton3=%s,miscellanoustab_cbutton4=%s,miscellanoustab_cbutton5=%s,miscellanoustab_cbutton6=%s,Estimate_prefix=%s,Customizeestimatetextlabels=%s,Customizeestimatetextlabels1=%s,Customizeestimatetextlabels2=%s,Customizeestimatetextlabels3=%s,Customizeestimatetextlabels4=%s,Customizeestimatetextlabels5=%s,Defaultestimatetemplate=%s,Startingestimatenumber=%s,Predefinedtextforestimates=%s,adv_Selectedtemplatepreview=%s,est_Headerboxbackgroundcolor=%s,Invoice_prifix=%s,invset_Headerboxbackgroundcolor=%s,Startinginvoicenumber=%sCustomizinvoicetextlabels=%s,Customizinvoicetextlabels1=%s,Customizinvoicetextlabels2=%s,Customizinvoicetextlabels3=%s,Customizinvoicetextlabels4=%s,Customizinvoicetextlabels4=%s,Customizinvoicetextlabels6=%s,Customizinvoicetextlabels7=%s,Customizinvoicetextlabels8=%s,Customizinvoicetextlabels9=%s,Customizinvoicetextlabels10=%s,Customizinvoicetextlabels11=%s,Customizinvoicetextlabels12=%s,Customizinvoicetextlabels13=%s,Customizinvoicetextlabels14=%s,Customizinvoicetextlabels15=%s,Customizinvoicetextlabels16=%s,Customizinvoicetextlabels17=%s,Customizinvoicetextlabels18=%s,Customizinvoicetextlabels19=%s,Customizinvoicetextlabels20=%s,Customizinvoicetextlabels21=%sCustomizinvoicetextlabels22=%s,Predefinedtextforinvoices=%s,Defaultinvoicetemplate=%s"
        val = (company_name,company_address,company_mail,company_salestax,currency,currencysign,  currencysign_placement,decimal_sepator,currency_example,date_format,example_dateformat,tax,printimage,  tax1name,tax1rate,printtax1,tax2name,tax2rate,printtax2,filename.split('/')[-1],radiobut,cbut1,cbut2,cbut3,cbut4,cbut5,cbut6,est_prefix,est_text1,est_text2,est_text3,est_text4,est_text5,est_text6,est_default,est_spin1,est_predefined,adv_default,est_header,invset_prefix,invset_header,invset_spin1,invset_text1,invset_text2,invset_text3,invset_text4,invset_text5,invset_text6,invset_text7,invset_text8,invset_text9,invset_text10,invset_text11,invset_text12,invset_text13,invset_text14,invset_text15,invset_text16,invset_text17,invset_text18,invset_text19,invset_text20,invset_text21,invset_text22,invset_text23,invset_predefined,invset_default)
        fbcursor.execute(sql, val)
        fbilldb.commit()
...
################### tab03 ###################################
  ...
  sql = "select * from company"
  fbcursor.execute(sql)
  invdata = fbcursor.fetchone()
  print(invdata)

  ver = Label(thirdtab,text="Invoice# prefix")
  ver.place(x=5,y=20)

  invset_str = StringVar() 
  invset_entry = Entry(thirdtab, textvariable=invset_str)
  invset_entry.place(x=100,y=20)
  if not invdata:
    invset_str.set('INV')
  else:
    invset_entry.insert(0 , invdata[54])
  ...
  reg = thirdtab.register(callback)

  invset_spin1.config(validate ="key", 
         validatecommand =(reg, '%s'))
  if not invdata:
    pass
  else:
    
    invset_spin1.delete(0, END)
    invset_spin1.insert(0,invdata[81])
  # invset_spin1.place(x=50,y=80)
  ...
  if not invdata:
    ...
    invset_winstyle1.insert(0, invdata[55])
  ...
  invset_str1 = StringVar() 
  invset_lbx1 = Entry(thirdtab1, width=30,textvariable=invset_str1)
  if not invdata:
    invset_str1.set('Invoice')
  else:
    invset_lbx1.insert(0, invdata[56])
  invset_lbx1.place(x=5,y=160)


  invset_str2 = StringVar() 
  invset_lbx2 = Entry(thirdtab1, width=30,textvariable=invset_str2)
  if not invdata:
    invset_str2.set('Invoice#')
  else:
    invset_lbx2.insert(0, invdata[58])
  invset_lbx2.place(x=5,y=180)


  invset_str3 = StringVar() 
  invset_lbx3 = Entry(thirdtab1, width=30,textvariable=invset_str3)
  if not invdata:
    invset_str3.set('Invoice date')
  else:
    invset_lbx3.insert(0, invdata[59])
  invset_lbx3.place(x=5,y=200)

  invset_str4 = StringVar() 
  invset_lbx4 = Entry(thirdtab1, width=30,textvariable=invset_str4)
  if not invdata:
    invset_str4.set('Order ref.#')
  else:
    invset_lbx4.insert(0, invdata[60])
  invset_lbx4.place(x=5,y=220)

  invset_str5 = StringVar() 
  invset_lbx5 = Entry(thirdtab1, width=30,textvariable=invset_str5)
  if not invdata:
    invset_str5.set('Terms')
  else:
    invset_lbx5.insert(0, invdata[61])
  invset_lbx5.place(x=5,y=240)

  invset_str6 = StringVar() 
  invset_lbx6 = Entry(thirdtab1, width=30,textvariable=invset_str6)
  if not invdata:
    invset_str6.set('Invoice to')
  else:
    invset_lbx6.insert(0, invdata[62])
  invset_lbx6.place(x=5,y=260)

  invset_str7 = StringVar() 
  invset_lbx7 = Entry(thirdtab1, width=30,textvariable=invset_str7)
  if not invdata:
    invset_str7.set('Ship to')
  else:
    invset_lbx7.insert(0, invdata[63])
  invset_lbx7.place(x=5,y=280)

  invset_str8 = StringVar() 
  invset_lbx8 = Entry(thirdtab1, width=30,textvariable=invset_str8)
  if not invdata:
    invset_str8.set('ID/SKU')
  else:
    invset_lbx8.insert(0, invdata[64])
  invset_lbx8.place(x=5,y=300)

  invset_str9 = StringVar()   
  invset_lbx9 = Entry(thirdtab1, width=30,textvariable=invset_str9)
  if not invdata:
    invset_str9.set('Quantity')
  else:
    invset_lbx9.insert(0, invdata[65])
  invset_lbx9.place(x=5,y=320)

  invset_str10 = StringVar() 
  invset_lbx10 = Entry(thirdtab1, width=30,textvariable=invset_str10)
  if not invdata:
    invset_str10.set('Description')
  else:
    invset_lbx10.insert(0, invdata[66])
  invset_lbx10.place(x=5,y=340)

  invset_str11 = StringVar() 
  invset_lbx11 = Entry(thirdtab1, width=30,textvariable=invset_str11)
  if not invdata:
    invset_str11.set('Unit Price')
  else:
    invset_lbx11.insert(0, invdata[67])
  invset_lbx11.place(x=5,y=360)

  invset_str12 = StringVar() 
  invset_lbx12 = Entry(thirdtab1, width=30,textvariable=invset_str12)
  if not invdata:
    invset_str12.set('Price')
  else:
    invset_lbx12.insert(0, invdata[68])
  invset_lbx12.place(x=5,y=380)

  invset_str13 = StringVar() 
  invset_lbx13 = Entry(thirdtab1, width=30,textvariable=invset_str13)
  if not invdata:
    invset_str13.set('Subtotal')
  else:
    invset_lbx13.insert(0, invdata[69])
  invset_lbx13.place(x=5,y=400)

  invset_str14 = StringVar() 
  invset_lbx14 = Entry(thirdtab1, width=30,textvariable=invset_str14)
  if not invdata:
    invset_str14.set('Discount')
  else:
    invset_lbx14.insert(0, invdata[70])
  invset_lbx14.place(x=5,y=420)

  invset_str15 = StringVar() 
  invset_lbx15 = Entry(thirdtab1, width=30,textvariable=invset_str15)
  if not invdata:
    invset_str15.set('Discount rate')
  else:
    invset_lbx15.insert(0, invdata[71])
  invset_lbx15.place(x=5,y=440)

  invset_str16 = StringVar() 
  invset_lbx16 = Entry(thirdtab1, width=30,textvariable=invset_str16)
  if not invdata:
    invset_str16.set('TAX1')
  else:
    invset_lbx16.insert(0, invdata[72])
  invset_lbx16.place(x=200,y=520)


  invset_str17 = StringVar() 
  invset_lbx17 = Entry(thirdtab1, width=30,textvariable=invset_str17)
  if not invdata:
    invset_str17.set('TAX2')
  else:
    invset_lbx17.insert(0, invdata[73])
  invset_lbx17.place(x=400,y=520)

  invset_str18 = StringVar() 
  invset_lbx18 = Entry(thirdtab1, width=30,textvariable=invset_str18)
  if not invdata:
    invset_str19.set('Total Paid')
  else:
    invset_lbx18.insert(0, invdata[74])
  invset_lbx18.place(x=600,y=520)


  invset_str19 = StringVar() 
  invset_lbx19 = Entry(thirdtab1, width=30,textvariable=invset_str19)
  if not invdata:
    invset_str19.set('Balance')
  else:
    invset_lbx19.insert(0, invdata[75])
  invset_lbx19.place(x=800,y=520)

  invset_str20 = StringVar() 
  invset_lbx20 = Entry(thirdtab1, width=30,textvariable=invset_str20)
  if not invdata:
    invset_str20.set('Terms and Conditions')
  else:
    invset_lbx20.insert(0, invdata[78])
  invset_lbx20.place(x=1000,y=520)


  invset_str21 = StringVar() 
  invset_lbx21 = Entry(thirdtab1, width=30,textvariable=invset_str21)
  if not invdata:
    invset_str21.set('Page')
  else:
    invset_lbx21.insert(0, invdata[76])
  invset_lbx21.place(x=5,y=460)

  invset_str22 = StringVar() 
  invset_lbx22 = Entry(thirdtab1, width=30,textvariable=invset_str22)
  if not invdata:
    invset_str22.set('Tax Exempted')
  else:
    invset_lbx22.insert(0, invdata[77])
  invset_lbx22.place(x=5,y=480)

  invset_str23 = StringVar() 
  invset_lbx23 = Entry(thirdtab1, width=30,textvariable=invset_str23)
  if not invdata:
    invset_str23.set('of')
  else:
    invset_lbx23.insert(0, invdata[79])
  ...
  invset_str24 = scrolledtext.ScrolledText(thirdtab)
  
  if  not invdata:
    pass
  else:
    invset_str24.insert('1.0', invdata[82])
  invset_str24.place(x=260,y=415,height=68,width=950)


  def restore_defaulttt2():
        invset_lbx1.delete(0, 'end')
        invset_lbx1.insert(0, 'Invoice')
        invset_lbx2.delete(0, 'end')
        invset_lbx2.insert(0,'Invoice#')
        invset_lbx3.delete(0, 'end')
        invset_lbx3.insert(0, 'Invoice date')
        invset_lbx4.delete(0, 'end')
        invset_lbx4.insert(0, 'Order ref.#')
        invset_lbx5.delete(0, 'end')
        invset_lbx5.insert(0, 'Terms')
        invset_lbx6.delete(0, 'end')
        invset_lbx6.insert(0, 'Invoice to')
        invset_lbx7.delete(0, 'end')
        invset_lbx7.insert(0, 'Ship to')
        invset_lbx8.delete(0, 'end')
        invset_lbx8.insert(0, 'ID/SKU')
        invset_lbx9.delete(0, 'end')
        invset_lbx9.insert(0, 'Quantity')
        invset_lbx10.delete(0, 'end')
        invset_lbx10.insert(0, 'Description')
        invset_lbx11.delete(0, 'end')
        invset_lbx11.insert(0, 'Unit Price')
        invset_lbx12.delete(0, 'end')
        invset_lbx12.insert(0, 'Price')
        invset_lbx13.delete(0, 'end')
        invset_lbx13.insert(0, 'Subtotal')
        invset_lbx14.delete(0, 'end')
        invset_lbx14.insert(0, 'Discount')
        invset_lbx15.delete(0, 'end')
        invset_lbx15.insert(0, 'Discount rate')
        invset_lbx16.delete(0, 'end')
        invset_lbx16.insert(0, 'TAX1')
        invset_lbx17.delete(0, 'end')
        invset_lbx17.insert(0, 'TAX2')
        invset_lbx18.delete(0, 'end')
        invset_lbx18.insert(0, 'Total Paid')
        invset_lbx19.delete(0, 'end')
        invset_lbx19.insert(0, 'Balance')
        invset_lbx20.delete(0, 'end')
        invset_lbx20.insert(0, 'Terms and Conditions')
        invset_lbx21.delete(0, 'end')
        invset_lbx21.insert(0, 'Page')
        invset_lbx22.delete(0, 'end')
        invset_lbx22.insert(0, 'Tax Exempted')
        invset_lbx23.delete(0, 'end')
        invset_lbx23.insert(0, 'of')
       

  invset_bttermadd_01 = Button(thirdtab,text="Restore defaults", command=restore_defaulttt2)
  invset_bttermadd_01.place(x=32,y=540)
  ...
  def invset_maindropmenu(event):
      ...
      if menuvar == 'Professional 1 (logo on left side)':
        ...
        canvas.create_text(500, 25, text="Title text goes here...", fill="black", font=('Helvetica 10'))
        try:
          invset_image = Image.open("images/"+invdata1[13])
          invset_resize_image = invset_image.resize((200,100))
          invset_image = ImageTk.PhotoImage(invset_resize_image)

          invset_btlogo = Label(canvas,width=200,height=100,image = invset_image) 
          window_image = canvas.create_window(175, 45, anchor="nw", window=invset_btlogo)
          invset_btlogo.photo = invset_image
        except:
          pass
        
        canvas.create_text(202, 160, text=""+invset_str2.get(), fill="black", font=('Helvetica 11'))
        canvas.create_text(215, 180, text=""+invset_str3.get(), fill="black", font=('Helvetica 11'))
        # canvas.create_text(200, 200, text=""+invset_str4.get(), fill="black", font=('Helvetica 11'))
        canvas.create_text(191, 220, text="Terms", fill="black", font=('Helvetica 11'))
        canvas.create_text(205, 240, text="Order ref.#", fill="black", font=('Helvetica 11'))
        canvas.create_text(350, 160, text="INV1/2022", fill="black", font=('Helvetica 11'))
        canvas.create_text(350, 180, text="05-05-2022", fill="black", font=('Helvetica 11'))
        canvas.create_text(350, 200, text="20-05-2022", fill="black", font=('Helvetica 11'))
        canvas.create_text(340, 220, text="NET 15", fill="black", font=('Helvetica 11'))
        ...
        T_address = Text(canvas, height=5, width=40, font=('Helvetica 10'),borderwidth=0)
        T_address.tag_configure('tag_name',justify='right')
        T_address.insert('1.0', invdata1[2])
        T_address.tag_add('tag_name','1.0', 'end')
        T_address_window = canvas.create_window(520, 80, anchor="nw", window=T_address)
        canvas.create_text(695, 180, text=" "+comsalestax.get(), fill="black", font=('Helvetica 10'))
        canvas.create_text(700, 205, text=" "+invset_str1.get(), fill="black", font=('Helvetica 14 bold'))
        canvas.create_text(706, 225, text="TAX EXEMPTED", fill="black", font=('Helvetica 10'))
          
        canvas.create_text(210, 260, text=""+invset_str5.get(), fill="black", font=('Helvetica 10 underline'))
        canvas.create_text(203, 280, text="John Doe", fill="black", font=('Helvetica 10 '))
        canvas.create_text(246, 295, text="381 South Bedford Road", fill="black", font=('Helvetica 10'))
        canvas.create_text(255, 310, text="Bedford Corners, NY 10549", fill="black", font=('Helvetica 10'))
        canvas.create_text(215, 325, text="United States", fill="black", font=('Helvetica 10'))
        ...
        s = ttk.Style()
        s.configure('mystyle_1.Treeview.Heading', background=''+invset_win_menu1.get(),State='DISABLE')
        ...
        # canvas.create_text(784, 479, text=""+comcursign.get()+"238"+""+comdecsep.get()+"00", fill="black", font=('Helvetica 10 bold'))
        canvas.create_text(650, 479, text=""+invset_str6.get(), fill="black", font=('Helvetica 10 bold'))
        if comcursignpla.get() == "before amount":
          canvas.create_text(784, 502, text=""+comcursign.get()+"100"+""+comdecsep.get()+"00", fill="black", font=('Helvetica 10'))
        elif comcursignpla.get() == "after amount":
          canvas.create_text(784, 502, text="100"+""+comdecsep.get()+"00"+""+comcursign.get(), fill="black", font=('Helvetica 10'))
        ...
        canvas.create_text(500, 600, text="Terms and Conditions", fill="black", font=('Helvetica 10'))
        canvas.create_line(150, 608, 795, 608)
        # canvas.create_text(280, 640, text= ""+invset_str7.get(), fill="black", font=('Helvetica 10')) 
        T = Text(canvas, height=3, width=90, font=('Helvetica 10'),borderwidth=0)
        T.insert(END, invdata1[82])
        T_window = canvas.create_window(155, 612, anchor="nw", window=T)
  ...
  #----------------Professional 2 (logo on right side)------------------
        ...
        try:
          ...
          invset_btlogo = Label(canvas,width=200,height=100,image = invset_image) 
          window_image = canvas.create_window(500, 45, anchor="nw", window=inv_btlogo)
          invset_btlogo.photo = invset_image
        except:
          pass  
        canvas.create_text(250, 60, text=" "+comname.get(), fill="black", font=('Helvetica 12 '))
        ...
        canvas.create_text(215, 180, text=" "+comsalestax.get(), fill="black", font=('Helvetica 10'))
        canvas.create_text(225, 205, text=""+invset_str1.get(), fill="black", font=('Helvetica 14 bold'))
        canvas.create_text(232, 225, text="TAX EXEMPTED", fill="black", font=('Helvetica 10'))
          
        canvas.create_text(502, 160, text=""+invset_str2.get(), fill="black", font=('Helvetica 11'))
        canvas.create_text(515, 180, text=""+invset_str3.get(), fill="black", font=('Helvetica 11'))
        canvas.create_text(500, 200, text=""+invset_str4.get(), fill="black", font=('Helvetica 11'))
        canvas.create_text(491, 220, text="Terms", fill="black", font=('Helvetica 11'))
        canvas.create_text(505, 240, text="Order ref.#", fill="black", font=('Helvetica 11'))
        canvas.create_text(690, 160, text="EST1/2022", fill="black", font=('Helvetica 11'))
        canvas.create_text(690, 180, text="05-05-2022", fill="black", font=('Helvetica 11'))
...
#----------------Simplified 1 (logo on left side)------------------ 
        ...
        canvas.create_text(708, 180, text=" "+comsalestax.get(), fill="black", font=('Helvetica 10'))
        canvas.create_text(710, 205, text=""+invset_str1.get(), fill="black", font=('Helvetica 14 bold'))
...
#----------------Simplified 2 (logo on right side)------------------ 
        ...
        try:
          ...
          invset_btlogo = Label(canvas,width=200,height=100,image = invset_image) 
          window_image = canvas.create_window(500, 45, anchor="nw", window=invset_btlogo)
          invset_btlogo.photo = invset_image
        except:
          pass  
        canvas.create_text(250, 60, text=" "+comname.get(), fill="black", font=('Helvetica 12 '))
...
#----------------Business Classic------------------ 
        ...
        try:
          ...
          invset_btlogo = Label(canvas,width=200,height=100,image = invset_image) 
          window_image = canvas.create_window(140, 120, anchor="nw", window=invset_btlogo)
          invset_btlogo.photo = invset_image
        except:
          pass  
        ...
        canvas.create_text(659, 180, text=""+invset_str1.get(), fill="black", font=('Helvetica 11'))
        canvas.create_text(675, 210, text=""+invset_str3.get(), fill="black", font=('Helvetica 11'))
        canvas.create_text(659, 240, text=""+invset_str4.get(), fill="black", font=('Helvetica 11'))
        ...
        canvas.create_text(585, 335, text="TAX1", fill="black", font=('Helvetica 10'))
        canvas.create_text(635, 360, text="Shipping and handling", fill="black", font=('Helvetica 10'))
        canvas.create_text(615, 385, text=""+invset_str6.get(), fill="black", font=('Helvetica 10 bold'))
        canvas.create_text(600, 410, text="Total Paid", fill="black", font=('Helvetica 10'))
        canvas.create_text(595, 435, text="Balance", fill="black", font=('Helvetica 10'))
  ...
  if not invdata:
    ...
    # canvas.create_text(700, 200, text=""+caddent.get('1.0', 'end-1c'), fill="black", font=('Helvetica 10'), width=125)
    # T_address = Text(canvas, height=5, width=20 , font=('Helvetica 10'))
    # T_address.insert(END, invdata[2])
    # T_address_window = canvas.create_window(645, 80, anchor="nw", window=T_address)
    canvas.create_text(700, 180, text=" "+comsalestax.get(), fill="black", font=('Helvetica 10'))
    canvas.create_text(700, 205, text=" "+invset_str1.get(), fill="black", font=('Helvetica 14 bold'))
    canvas.create_text(706, 225, text="TAX EXEMPTED", fill="black", font=('Helvetica 10'))
    ...
    # canvas.create_text(280, 640, text= ""+invset_str7.get(), fill="black", font=('Helvetica 10')) 
    # T = Text(canvas, height=3, width=105, font=('Helvetica 10'))
    # T.insert(END, invdata[82])
    # T_window = canvas.create_window(105, 612, anchor="nw", window=T)


    canvas.create_text(280, 670, text="Page footer text goes here...", fill="black", font=('Helvetica 10'))
    canvas.create_text(720, 670, text="Page 1 of 1", fill="black", font=('Helvetica 10')) 
  elif invdata[57] == 'Professional 1 (logo on left side)':
    invset_winstyle2.insert(0, invdata[57])
    frame = Frame(thirdtab, width=953, height=300)
    frame.pack(expand=True, fill=BOTH)
    frame.place(x=247,y=90)
    canvas=Canvas(frame, bg='grey', width=953, height=300, scrollregion=(0,0,700,700))
    ...
    canvas.create_text(500, 25, text="Title text goes here...", fill="black", font=('Helvetica 10'))
    try:
      invset_image = Image.open("images/"+invdata[13])
      invset_resize_image = invset_image.resize((200,100))
      invset_image = ImageTk.PhotoImage(invset_resize_image)
    ...
    T_address = Text(canvas, height=5, width=40, font=('Helvetica 10'),borderwidth=0)
    T_address.tag_configure('tag_name',justify='right')
    T_address.insert('1.0', invdata[2])
    T_address.tag_add('tag_name','1.0', 'end')
    T_address_window = canvas.create_window(520, 80, anchor="nw", window=T_address)
    canvas.create_text(695, 180, text=" "+comsalestax.get(), fill="black", font=('Helvetica 10'))
    canvas.create_text(700, 205, text=" "+invset_str1.get(), fill="black", font=('Helvetica 14 bold'))
    ...
    canvas.create_text(280, 670, text="Page footer text goes here...", fill="black", font=('Helvetica 10'))
    canvas.create_text(720, 670, text="Page 1 of 1", fill="black", font=('Helvetica 10'))
  elif invdata[57] == 'Professional 2 (logo on right side)':
    invset_winstyle2.insert(0, invdata[57])
    frame = Frame(thirdtab, width=953, height=300)
    frame.pack(expand=True, fill=BOTH)
    frame.place(x=247,y=90)
    ...
    canvas.create_text(280, 670, text="Page footer text goes here...", fill="black", font=('Helvetica 10'))
    canvas.create_text(720, 670, text="Page 1 of 1", fill="black", font=('Helvetica 10'))
  elif invdata[57] == 'Simplified 1 (logo on left side)':
    invset_winstyle2.insert(0, invdata[57])
    frame = Frame(thirdtab, width=953, height=300)
    frame.pack(expand=True, fill=BOTH)
    frame.place(x=247,y=90)
    ...
    canvas.create_text(280, 670, text="Page footer text goes here...", fill="black", font=('Helvetica 10'))
    canvas.create_text(720, 670, text="Page 1 of 1", fill="black", font=('Helvetica 10'))
  elif invdata[57] == 'Simplified 2 (logo on right side)':
    invset_winstyle2.insert(0, invdata[57])
    frame = Frame(thirdtab, width=953, height=300)
    frame.pack(expand=True, fill=BOTH)
    frame.place(x=247,y=90)
    ...
    canvas.create_text(280, 670, text="Page footer text goes here...", fill="black", font=('Helvetica 10'))
    canvas.create_text(720, 670, text="Page 1 of 1", fill="black", font=('Helvetica 10'))
  elif invdata[57] == 'Business Classic':
    invset_winstyle2.insert(0, invdata[57])
    frame = Frame(thirdtab, width=953, height=300)
    frame.pack(expand=True, fill=BOTH)
    frame.place(x=247,y=90)
  ...
  sql = "select * from company"
  fbcursor.execute(sql)
  ordsetdata = fbcursor.fetchone()
  print(ordsetdata)



  ordset_ver = Label(fourthtab,text="Order# prefix")
  ordset_ver.place(x=5,y=40)

  ordset_str = StringVar() 
  ordset_entry = Entry(fourthtab, textvariable=ordset_str)
  ordset_entry.place(x=100,y=40)
  if not ordsetdata:
    ordset_str.set('ordset')
  else:
    ordset_entry.insert(0, ordsetdata[2])

  ordset_ver = Label(fourthtab,text="Starting Order number")
  ...
  ordset_spin1 = Spinbox(fourthtab,from_=0,to=1000000,width=15)
  reg = fourthtab.register(callback)
  
  ordset_spin1.config(validate ="key", 
         validatecommand =(reg, '%s'))
  if not ordsetdata:
    pass
  else:
    ordset_spin1.delete(0, END)
    ordset_spin1.insert(0,ordsetdata[11])
  ...
  ordset_winstyle1 = ttk.Combobox(fourthtab,textvariable=win_menu1)
  #ordset_win1 = win_menu1.get()
  ...
  if not ordsetdata:
     ...
     ordset_winstyle1.insert(0, ordsetdata[3])
  ordset_winstyle1.place(x=6 ,y=160)
  #winstyle1.current(0)

  ordset_ver = Label(fourthtab,text="Customize Order text labels")
  ordset_ver.place(x=5,y=190)
  
  ordset_str1 = StringVar() 
  ordset_lbx1 = Entry(fourthtab, width=30,textvariable=ordset_str1)
  # ordset_str1.set('Order')
  if not ordsetdata:
    ordset_str1.set('Order')
  else:
    ordset_lbx1.insert(0, ordsetdata[4])
    ordset_lbx1.place(x=5,y=220)
  
  ordset_str2 = StringVar() 
  ordset_lbx2 = Entry(fourthtab, width=30,textvariable=ordset_str2)
  if not ordsetdata:
    ordset_str2.set('Order#')
  else:
    ordset_lbx2.insert(0,ordsetdata[6])
  ordset_lbx2.place(x=5,y=240)
  
  
  ordset_str3 = StringVar() 
  ordset_lbx3 = Entry(fourthtab,width=30,textvariable=ordset_str3)
  if not ordsetdata:
    ordset_str3.set('Order date')
  else:
    ordset_lbx3.insert(0, ordsetdata[7])
  ordset_lbx3.place(x=5,y=260) 

  ordset_str4 = StringVar() 
  ordset_lbx4 = Entry(fourthtab,width=30,textvariable=ordset_str4)
  if not ordsetdata:
    ordset_str4.set('Due date')
  else:
    ordset_lbx4.insert(0, ordsetdata[8])
  ordset_lbx4.place(x=5,y=280)

  ordset_str5 = StringVar() 
  ordset_lbx5 = Entry(fourthtab,width=30,textvariable=ordset_str5)
  if not ordsetdata:
    ordset_str5.set('Order to')
  else:
    ordset_lbx5.insert(0, ordsetdata[9])
  ordset_lbx5.place(x=5,y=300)

  ordset_str6 = StringVar() 
  ordset_lbx6 = Entry(fourthtab, width=30,textvariable=ordset_str6)
  if not ordsetdata:
    ordset_str6.set('Order total')
  else:
    ordset_lbx6.insert(0, ordsetdata[10])
  ...
  messagelbframe=LabelFrame(fourthtab,text="Predefined terms and conditions text for Orders", height=70, width=980)
  messagelbframe.place(x=248, y=396)

  
  # ordset_str7 = StringVar() 
  # entry1=Entry(fourthtab, width=155,textvariable=ordset_str7)
  # if not ordsetdata:
  #   pass
  # else:
  #   entry1.insert(0, ordsetdata[39])
  # entry1.place(x=260, y=415, height=36)
  
  ordset_str7 = scrolledtext.ScrolledText(fourthtab)
  if  not ordsetdata:
    pass
  else:
    ordset_str7.insert('1.0', ordsetdata[12])
  ordset_str7.place(x=260,y=415,height=38,width=950)


  def rordsetore_defaulttt1():
        ordset_lbx1.delete(0, 'end')
        ordset_lbx1.insert(0, 'Order')
        ordset_lbx2.delete(0, 'end')
        ordset_lbx2.insert(0,'Order#')
        ordset_lbx3.delete(0, 'end')
        ordset_lbx3.insert(0, 'Order date')
        ordset_lbx4.delete(0, 'end')
        ordset_lbx4.insert(0, 'Due date')
        ordset_lbx5.delete(0, 'end')
        ordset_lbx5.insert(0, 'Order to')
        ordset_lbx6.delete(0, 'end')
        ordset_lbx6.insert(0, 'Order total')

  ordset_bttermadd_01 = Button(fourthtab,text="Rordsetore defaults", command=rordsetore_defaulttt1)
  ordset_bttermadd_01.place(x=32,y=430)
